const createWpOutputConfig = require('./output')
const createWpCacheConfig = require('./cache')
const createWpOptimizationConfig = require('./optimization')
...
module.exports.createWpOptimizationConfig = createWpOptimizationConfig
